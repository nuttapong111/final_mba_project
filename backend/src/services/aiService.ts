...
ไฟล์ที่แนบมา (2 ไฟล์ PDF):
- ไฟล์แรก: ไฟล์ PDF ที่เป็นโจทย์/คำถามที่อาจารย์สร้างขึ้น
- ไฟล์ที่สอง: ไฟล์ PDF ที่เป็นคำตอบของนักเรียน

**ขั้นตอนการตรวจ:**
1. อ่านไฟล์แรก (โจทย์) เพื่อดูว่ามีโจทย์อะไรบ้าง
2. อ่านไฟล์ที่สอง (คำตอบ) เพื่อดูว่านักเรียนตอบโจทย์หรือไม่
3. เปรียบเทียบเนื้อหาของทั้งสองไฟล์

**กรณีที่ต้องให้คะแนน 0 (สำคัญมาก):**
- ถ้าไฟล์ที่สอง (คำตอบ) เหมือนกับไฟล์แรก (โจทย์) ทุกประการ หรือเป็นไฟล์เดียวกัน → **ต้องให้คะแนน 0** พร้อม feedback: "นักเรียนยังไม่ได้ทำการบ้าน ยังเป็นแค่โจทย์ที่อาจารย์ให้ กรุณาทำการบ้านและส่งไฟล์คำตอบที่ถูกต้อง" (ห้ามบอกว่า "ไม่สามารถตรวจได้" หรือ "ไฟล์ไม่ถูกแนบมา")
- ถ้าไฟล์ที่สองไม่มีเนื้อหาหรือว่างเปล่า → ให้คะแนน 0 พร้อม feedback: "นักเรียนยังไม่ได้ทำการบ้าน กรุณาทำการบ้านและส่งไฟล์คำตอบ"
- ถ้าไฟล์ที่สองไม่ใช่คำตอบ (เช่น เป็นเอกสารประกอบการเรียน โจทย์ซ้ำ หรือไม่มีคำตอบ) → ให้คะแนน 0 พร้อม feedback ที่เหมาะสม

**การให้คะแนน (สำคัญมาก):**
- ถ้าไฟล์คำตอบเหมือนกับไฟล์โจทย์ → **ต้องให้คะแนน 0** พร้อม feedback ที่บอกว่า "นักเรียนยังไม่ได้ทำการบ้าน ยังเป็นแค่โจทย์ที่อาจารย์ให้" (ห้ามบอกว่า "ไม่สามารถตรวจได้" หรือ "ไฟล์ไม่ถูกแนบมา")
- ถ้าไฟล์คำตอบไม่มีเนื้อหาหรือไม่ใช่คำตอบ → ให้คะแนน 0 พร้อม feedback ที่เหมาะสม
- ถ้านักเรียนตอบถูกต้องและครบถ้วน → ให้คะแนนตามความถูกต้อง (1-${maxScore})
- ถ้านักเรียนตอบแต่ไม่ถูกต้องหรือไม่ครบ → ให้คะแนนตามความถูกต้อง (1-${maxScore})

**หมายเหตุสำคัญ:** เมื่อไฟล์คำตอบเหมือนกับไฟล์โจทย์ ต้องให้คะแนน 0 และบอกว่า "นักเรียนยังไม่ได้ทำการบ้าน" ห้ามบอกว่า "ไม่สามารถตรวจได้" หรือ "ไฟล์ไม่ถูกแนบมา"

กรุณาอ่านเนื้อหาในไฟล์ PDF ทั้งสองไฟล์ เปรียบเทียบคำตอบกับโจทย์ และให้:
1. คะแนน (0-${maxScore}) โดยพิจารณาจากความถูกต้อง ความสมบูรณ์ และความชัดเจนของคำตอบเมื่อเทียบกับโจทย์
2. คำแนะนำที่เป็นประโยชน์สำหรับนักเรียน (ถ้าได้คะแนน 0 ให้แนะนำให้นักเรียนทำการบ้านและส่งไฟล์คำตอบที่ถูกต้อง)
