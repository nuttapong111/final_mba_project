...
2. **ไฟล์ที่สอง (ไฟล์คำตอบ):** ไฟล์ PDF ที่เป็นคำตอบของนักเรียน - นี่คือไฟล์ที่ต้องตรวจและให้คะแนน

**⚠️ สิ่งสำคัญที่ต้องทำ:**
- **ไฟล์ทั้งสองถูกส่งมาแล้ว** กรุณาอ่านเนื้อหาในไฟล์ PDF ทั้งสองไฟล์
- ไฟล์แรกเป็นโจทย์ ไฟล์ที่สองเป็นคำตอบ
- **ต้องอ่านไฟล์ทั้งสองก่อน** แล้วจึงเปรียบเทียบกัน
- ถ้าอ่านไฟล์ไม่ได้ ให้บอกว่า "ไม่สามารถอ่านเนื้อหาในไฟล์ PDF ได้" พร้อมระบุว่าเป็นไฟล์ไหน

**ขั้นตอนการตรวจ (ทำตามลำดับ):**
1. **อ่านไฟล์แรก (โจทย์):** อ่านเนื้อหาในไฟล์ PDF แรกเพื่อเข้าใจว่ามีโจทย์อะไรบ้างที่นักเรียนต้องทำ
2. **อ่านไฟล์ที่สอง (คำตอบ):** อ่านเนื้อหาในไฟล์ PDF ที่สองเพื่อดูว่านักเรียนตอบโจทย์ครบถ้วนหรือไม่
3. **เปรียบเทียบ:** เปรียบเทียบคำตอบกับโจทย์เพื่อประเมินความถูกต้อง
4. **ให้คะแนน:** ให้คะแนนตามความถูกต้อง ความสมบูรณ์ และความชัดเจน

**การให้คะแนน:**
- ถ้านักเรียนตอบถูกต้องและครบถ้วน: ให้คะแนนสูง (ใกล้ ${maxScore})
- ถ้านักเรียนตอบถูกแต่ไม่ครบ: ให้คะแนนปานกลาง
- ถ้านักเรียนตอบผิดหรือไม่ตอบ: ให้คะแนนต่ำ (แต่ไม่ใช่ 0 ถ้ายังมีเนื้อหาบางส่วน)
- **ห้ามให้คะแนน 0** เว้นแต่ว่าไฟล์คำตอบว่างเปล่าหรือไม่มีเนื้อหาเลย
