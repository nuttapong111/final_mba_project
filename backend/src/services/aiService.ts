...
**กรณีที่ต้องให้คะแนน 0:**
- ถ้าไฟล์ที่สอง (คำตอบ) เหมือนกับไฟล์แรก (โจทย์) ทุกประการ หรือเป็นไฟล์เดียวกัน → ให้คะแนน 0 พร้อม feedback: "นักเรียนยังไม่ได้ทำการบ้าน ยังเป็นแค่โจทย์ที่อาจารย์ให้ กรุณาทำการบ้านและส่งไฟล์คำตอบที่ถูกต้อง"
- ถ้าไฟล์ที่สองไม่มีเนื้อหาหรือว่างเปล่า → ให้คะแนน 0
- ถ้าไฟล์ที่สองไม่ใช่คำตอบ (เช่น เป็นเอกสารประกอบการเรียน โจทย์ซ้ำ หรือไม่มีคำตอบ) → ให้คะแนน 0

**การให้คะแนน:**
- ถ้าไฟล์คำตอบเหมือนกับไฟล์โจทย์ → ให้คะแนน 0 (ไม่ใช่ "ไม่สามารถให้คะแนนได้")
- ถ้าไฟล์คำตอบไม่มีเนื้อหาหรือไม่ใช่คำตอบ → ให้คะแนน 0
